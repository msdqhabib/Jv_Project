...
class Property(models.Model):
    ...
    percentage_shareholding = models.DecimalField(max_digits=5, decimal_places=2)
    feasibility_of_project = models.TextField()
    land_price_to_be_paid_to_dha = models.DecimalField(max_digits=10, decimal_places=2)
